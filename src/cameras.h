...
namespace edupt
{
    ...
    public:
        ...
        PinholeCamera(const double width, const double height, const double screen_height_, const double screen_dist_,
                      const Vec& camera_position_, const Vec& camera_dir_, const Vec& camera_up_,
                      const double supersamples_)
            : image_width(width),
              image_height(height),
    ...
    public:
        ...
        DoFCamera(const double width, const double height, const double screen_height_, const double screen_dist_,
                  const Vec& camera_position_, const Vec& camera_dir_, const Vec& camera_up_,
                  const double supersamples_, const double aperture_, const double focus_dist_, std::mt19937& engine)
            : image_width(width),
              image_height(height),
              screen_width(screen_height_ * width / height),
              screen_height(screen_height_),
              ...
              sampler_(PointSamplerDisk(engine))
        {
        }
